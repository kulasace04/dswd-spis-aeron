<div x-data="{ toggle() { window.scrollTo({ top: 0, behaviour: 'smooth' }) } }">
                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gray-900 border border-gray-300 cursor-default leading-5">{{ $element }}</span>
                                </span>
                            @endif
